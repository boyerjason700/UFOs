...
function updateFilters() {
    ...
    // change input to lowercase to match table value from https://www.w3schools.com/jsref/jsref_tolowercase.asp
    var filterValue1 = filterValue.toLowerCase();
    ...
    if (filterValue1) {
      filteredData[filterId] = filterValue1;
    } else {
